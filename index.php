...
.nc{background:linear-gradient(var(--card),var(--card)) padding-box,linear-gradient(135deg,#c9a7ff,#a06bff) border-box;border:1px solid transparent;border-radius:var(--r);box-shadow:0 2px 12px rgba(0,0,0,0.06);padding:24px;margin-bottom:16px}
...
.reward-modal{background:linear-gradient(var(--card),var(--card)) padding-box,linear-gradient(135deg,#c9a7ff,#a06bff) border-box;border:1px solid transparent;border-radius:16px;width:min(88vw,320px);padding:20px 18px 16px;box-shadow:0 12px 40px rgba(0,0,0,.25);text-align:center;max-height:90vh;overflow-y:auto}
...
<a href="?p=<?php echo htmlspecialchars($cpg['slug']);?>" style="display:flex;align-items:center;justify-content:space-between;padding:14px 18px;border-radius:12px;background:linear-gradient(var(--card),var(--card)) padding-box,linear-gradient(135deg,#c9a7ff,#a06bff) border-box;border:1px solid transparent;box-shadow:0 1px 8px rgba(0,0,0,0.04);margin-bottom:10px;text-decoration:none;color:var(--tx);font-size:.93em;font-weight:600"><span style="display:flex;align-items:center;gap:10px"><span style="font-size:1.3em"><?php echo htmlspecialchars($cpg['icon']??'');?></span><span><?php echo htmlspecialchars($cpg['title']);?></span></span><span class="ar">›</span></a>
