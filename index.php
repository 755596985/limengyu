...
.nc{background:var(--card);border:1px solid #8b5cf6;border-radius:var(--r);box-shadow:0 2px 12px rgba(0,0,0,0.06);padding:24px;margin-bottom:16px}
.ncs{padding:16px;border:1px solid #8b5cf6;border-radius:var(--rs);box-shadow:0 1px 8px rgba(0,0,0,0.04);background:var(--card);margin-bottom:12px}
...
.reward-modal{background:var(--card);border:1px solid #8b5cf6;border-radius:16px;width:min(88vw,320px);padding:20px 18px 16px;box-shadow:0 12px 40px rgba(0,0,0,.25);text-align:center;max-height:90vh;overflow-y:auto}
