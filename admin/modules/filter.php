...
?>
<?php if ($tab === 'filter'): ?>
<div class="card"><div class="card-title"><?php echo m_ico_badge('ban'); ?>敏感词设置</div>
<div style="font-size:.85em;color:var(--tl);margin-bottom:16px"><span class="lbl-ico"><?php echo m_ico("tag", 15); ?></span> 前台留言和说说内容中包含的敏感词将被自动替换为 * 号。</div>
...
<button type="submit" class="btn primary small"><span class="lbl-ico"><?php echo m_ico("plus", 15); ?></span> 添加</button>
</form>
</div>
<div class="card"><div class="card-title"><?php echo m_ico_badge('list'); ?>敏感词列表 (<?php echo count($filter_words); ?>个)</div>
